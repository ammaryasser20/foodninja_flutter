...
//
  ...
  static String signUpScreenTitle =
  ...
  static String keepMeSignedIn =
      S.of(NavigationService.navigatorKey.currentContext!).keepMeSignedIn;
  static String emailMeAboutSpecialPricing = S
      .of(NavigationService.navigatorKey.currentContext!)
  ...
  static String haveNotAccount =
      S.of(NavigationService.navigatorKey.currentContext!).haveNotAccount;
  static String emailAndPasswordInvalid = S
      .of(NavigationService.navigatorKey.currentContext!)
  ...
  static String theEmailOrPasswordIsIncorrect = S
      .of(NavigationService.navigatorKey.currentContext!)
      .theEmailOrPasswordIsIncorrect;
  static String theEmailHasAlreadyBeenTaken = S
      .of(NavigationService.navigatorKey.currentContext!)
      .theEmailHasAlreadyBeenTaken;
  static String nameCantBeEmpty =
